...
const StoryDetailsPage = async ({ params }) => {
    ...
    if (!story) {
        return <Title>Sorry!!! Story Not Found</Title>
    }

    return (
        <div className="max-w-3xl mx-auto bg-black shadow-md rounded-lg p-6 border border-gray-200">
            {/* Top Section */}
            <div className="flex items-center gap-5">
                ...
                <div>
                    ...
                    <p className="text-gray-200">{story.designation}</p>
                    <p className="text-blue-600">{story.company}</p>
                    <p className="text-gray-200 mt-1">Experience: {story.experience}</p>
                </div>
            </div>
            ...
            <div className="mt-6">
                ...
                <p className="text-gray-200 leading-relaxed">{story.story}</p>
            </div>

            {/* About */}
            <div className="mt-6">
                <h2 className="text-xl font-semibold mb-2">About Developer</h2>
                <p className="text-gray-200 leading-relaxed">{story.about}</p>
            </div>
