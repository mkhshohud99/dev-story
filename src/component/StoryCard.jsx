...
export default function StoryCard({ story }) {
  ...
  return (
    <div className="max-w-3xl bg-black shadow-md rounded-lg p-4 border border-gray-200">
      {/* Image */}
      <div className="flex items-center gap-4">
        ...
        />
        <div>
          <h2 className="font-semibold text-lg text-white">{story.name}</h2>
      ...
      {/* Story */}
      <p className="mt-4 text-gray-300 text-sm">{shortStory}</p>
